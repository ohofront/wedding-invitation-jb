  ...
  return (
    <div className='relative mt-6 mx-auto w-[82%] min-h-[80px] leading-none z-0 overflow-hidden'>
      ...
      <video
        ...
        playsInline
      >
        <source src='https://mcard.fromtoday.co.kr/mcard/assets/flower_00.mp4' type='video/mp4' />
      </video>

      {/* 이미지 (비디오 아래 배치) */}
      <img src={maintopImage} alt='Wedding' className='relative z-0 w-full shadow-lg' />
    </div>
  );
};
